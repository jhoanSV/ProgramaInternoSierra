...
Module Exportar
    ...
    Function llenarExcelAlstarPedidos(ByVal ElGrid As DataGridView) As Boolean
        ...
        Try
            ...
            For Fila As Integer = 0 To NRow - 1
                ...
                For Col As Integer = 0 To NCol - 1
                    ...
                    c = ElGrid.Rows(Fila).DefaultCellStyle.BackColor
                    If c.IsEmpty = False Then

                        exHoja.Cells.Item(Fila + 2, Col + 1).Interior.Color = Color.OrangeRed
                    End If
